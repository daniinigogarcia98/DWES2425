    ...
    <form action="" method="post">
        <fieldset>
            ...
            <div>
                ...
                <input type="radio" id="general" name="general" value="general" checked="checked"/>
                <label for="general">General</label>
                <input type="radio" id="mayor60" name="mayor60" value="mayor60" />
                <label for="mayor60">Mayor de 60</label>
                <input type="radio" id="Menor6" name="Menor6" value="Menor6" />
