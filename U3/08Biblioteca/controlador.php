                ...
                if ($bd->crearUsuario($u, $s)) {
                    ...
                    if($email->getCa()!=null){
                        $textoHTML='<h1>'.$s->getNombre().
                            ', bienvenido a la Biblioteca de Daniel</h1>'
                        ...
                        $textoNoHTML=$s->getNombre().
                            ', bienvenido a la Biblioteca de Daniel.\n'
                            .'Tus credenciales de acceso son:\n'
                            .'Usuario:'.$s->getUs().'\n'
                            .'Contraseña:'.$s->getUs().'\n'
                            .'\n'
                            .'No olivides cambiar tu contraseña en el primer acceso';
                            if($email->enviarCorreo('Creedenciales acceso Biblioteca',$s,$textoHTML,$textoNoHTML)){
